...
# 📁 **Week 12 – Technical End‑of‑Phase Project (TEPP) & Full‑Range Security Assessment**

Although I wasn’t able to complete the Week 12 TEPP assignment, this week represented the capstone of the entire phase: a full‑range, multi‑environment security assessment that combined reconnaissance, vulnerability remediation, forensic investigation, and exploitation analysis. The TEPP required working across three separate subnets and documenting every phase of the investigation inside a comprehensive tepp_postmortem.md report.
